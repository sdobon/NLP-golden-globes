...
#     for i in range(3):
#         keywords += returns[i] + ' golden globes 2013,'
...
#
#
#     print("\nMost upset three categories are: ", sorted_score[0],', ', sorted_score[1],', ', sorted_score[2])
...
#         print(worsts[i])
#         print('-----------------------')
#     print("Least upset three categories are: ", sorted_score[-1],', ', sorted_score[-2],', ', sorted_score[-3])
